...
rows. The Apple capture holds 61 rows and reaches back to a filing reported on
2011-07-20.
...
`ticker`. Verified: `{ "ticker": "AAPL", "cik": "1652044" }` returned Apple.
  ...
  "data": [
    {
      ...
      "cik": "320193",
      "float": {
        "outstandingShares": [{ "period": "2026-07-17", "shareClass": "", "value": 14594180000 }],
        "publicFloat": []
      },
    ...
    },
    {
      ...
      "tickers": ["AAPL"],
      "float": {
        "outstandingShares": [{ "period": "2025-10-17", "shareClass": "", "value": 14776353000 }],
        "publicFloat": [{ "period": "2025-03-28", "shareClass": "", "value": 3253431000000 }]
      }
    }
  ]
}
...
- The server caps the underlying query at 200 records. Apple has 61, so the cap
  was not reached in testing.
- The tool description calls public float "shares held by non-affiliates". The
  captured `publicFloat[].value` is a dollar amount. Trust the capture.
